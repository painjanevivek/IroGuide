...
export function BriefBuilder({ user }: { user: User }) {
  ...
  return (
    <section className="learning-tool" aria-labelledby="brief-builder-title">
      ...
      {record?.status === "ready" ? <div className="learning-completion"><CheckCircle2 /><div><strong>Your brief is ready.</strong><p>You prepared critique context without uploading an image. Use it when you start your personalized review.</p></div></div> : null}
