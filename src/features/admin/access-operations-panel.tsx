...
export function AccessOperationsPanel() {
  ...
  return <main className="access-operations-main">
    <header className="access-operations-hero"><div><p className="eyebrow">Operator research</p><h1>Review demand without restricting public access.</h1><p>Filter optional category interest, record a reasoned classification, and keep every mutation replay-safe and audited. These records never control critique eligibility or send email.</p></div><ShieldCheck /></header>
